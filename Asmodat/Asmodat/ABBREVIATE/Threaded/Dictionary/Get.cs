...
namespace Asmodat.Abbreviate
{
    public partial class ThreadedDictionary<TKey, TValue> : SortedDictionary<TKey, TValue>
    {
        ...
        {
            lock (this)
                if (this.ContainsKey(key1) && this[key1] != null)
                {

                    ThreadedDictionary<TK2, ThreadedDictionary<TK3, TV3>> that = this[key1] as ThreadedDictionary<TK2, ThreadedDictionary<TK3, TV3>>;

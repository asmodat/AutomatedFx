...
namespace Asmodat.Abbreviate
{
    public static class String
    {
        ...
        public static string Extract(string sData, string sStartTag, string sEndTag)
        {
            ...
            if(iST > iET)
            {
                ...
                return String.Extract(sData, sStartTag, sEndTag);
            }
        ...
        public static string Extract(string sData, string sStartTag, string sEndTag, out string sDataResidue)
        {
            ...
            {
                sData = sData.Remove(0, iET + sEndTag.Length);
                return String.Extract(sData, sStartTag, sEndTag, out sDataResidue);
            }
